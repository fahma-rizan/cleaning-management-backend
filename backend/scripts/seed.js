...
const SAMPLE_INVENTORY = [
  { name: 'Detergent Powder', sku: 'DET-001', type: INVENTORY.CONSUMABLE_TYPES.CLEANING_CHEMICALS, unit: 'kg',     quantity: 50, costPerUnit: 850, lowStockThreshold: 10, supplier: { name: 'CleanCo Supplies', contact: '+94 11 234 5678' } },
  { name: 'Fabric Softener',  sku: 'FAB-001', type: INVENTORY.CONSUMABLE_TYPES.CLEANING_CHEMICALS, unit: 'litres', quantity: 30, costPerUnit: 650, lowStockThreshold: 8  },
  { name: 'Starch Spray',     sku: 'STA-001', type: INVENTORY.CONSUMABLE_TYPES.CLEANING_CHEMICALS, unit: 'pcs',    quantity: 24, costPerUnit: 450, lowStockThreshold: 5  },
];
