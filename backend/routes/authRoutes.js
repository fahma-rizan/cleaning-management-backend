...
router.get('/me',                     checkPasswordChange, authController.getProfile);    // spec path
router.get('/profile',                checkPasswordChange, authController.getProfile);    // original path
router.put('/profile',                checkPasswordChange, authController.updateProfile);  // update name/phone
router.post('/change-password',       checkPasswordChange, authController.changePassword); // change password (requires current)
